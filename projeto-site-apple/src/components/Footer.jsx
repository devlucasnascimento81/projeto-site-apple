        ...
        <footer className="bg-gray-900 border-t border-gray-800">
                        ...
                        <div key={index}>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                {section.links.map((link, linkIndex) => (
                                    <li key={linkIndex}>
                                        <a href="#" className="hover:text-white transition-all duration-200 ease-in cursor-pointer">{link}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>
            ...
            <div className="border-t border-gray-800 pt-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-md text-gray-500">Copyright  2025 Apple Inc. Todos os direitos reservados.</p>
                ...
                <p className="text-xs text-gray-500 mt-6 ">Site criado para fins educacionais - Aula no YouTube, Criado por: Lucas Nascimento Campos.</p>
            </div>
        </footer>
    )
}
