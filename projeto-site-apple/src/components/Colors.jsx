...
function Colors(){
    ...
    const [selectedColor, setSeelectedColor] = useState('blue')
        ...
        <section id="colors" className="bg-black py-20 px-8" >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center items-center gap-4">
                   {colors.map( color => (
                    <button key={color.id} onClick={() => setSeelectedColor(color.id)} className={`relative transition-all duration-300 cursor-pointer hover:scale-105 ease-in`}>
                ...
                <div className="text-center mt-16">
                    <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-2 hover:scale-105 shadow-md shadow-blue-500/30 cursor-pointer">
                        Compre agora á partir de R$9.950,00
                    </button>
                    <p>Ou em até 12x de R$ 829,16</p>
                </div>
